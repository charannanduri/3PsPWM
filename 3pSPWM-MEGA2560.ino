...
TCCR0A=0;//resets the value of Timer 0 Reg. A
TCCR0B=0;//resets the value of Timer 0 Reg. B
TCNT0=0;//resets the value of Timer 0
  ...
  if ((j==209) || OK3==1){//if j equal with 209 enable third signal
    OK3=1;//mantain if function
      ...
      if(OK4==1){
        ...
        OCR3B=z;//enable pin 2 to correspoxnding duty cycle
      }
  }
}
